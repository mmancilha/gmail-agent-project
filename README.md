...
Create a file named .env in the project root by copying the example below. No changes are needed for the default SQLite setup.

```env
# .env
DATABASE_URL="sqlite:///./agents.db"
FERNET_KEY="u2Pz_AL2o_bVSEas_8Ge-xPEw22a2i-pSStkEL3a4D4="
```
